# QBI Public Crosswalk

This document is independent public-source research for learning and interoperability.

It is **not** a QBI implementation, QBI-readiness determination, representation of an internal evaluation process, or affiliation with or endorsement by DARPA, QBI, or any participant.
...
| R&D risk identification | Claims, assumptions, risks, and dependencies |
| Prototype evidence | FMA evidence and research-receipt references |
| Technical review | Expert Adjudication Record |
| Change sensitivity | Dependency impact + applicability reassessment |
| Decision basis | FMA Decision Receipt / Mission Decision Packet |
