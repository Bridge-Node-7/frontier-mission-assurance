.PHONY: install test lint validate assumptions coverage impact receipt reproduce report schema boundary evaluate fingerprint profile-manifests external-adoption scientific-discovery orbital-recovery orbital-recovery-benchmark ftqc ftqc-evaluate ftqc-case demo check clean
...
check: lint test validate assumptions coverage receipt reproduce report evaluate fingerprint profile-manifests external-adoption scientific-discovery orbital-recovery orbital-recovery-benchmark ftqc ftqc-evaluate ftqc-case boundary
